...
- The current conclusion remains `NOT_READY`: native Windows NSIS and macOS universal DMG builds, signing/notarization, and install-lifecycle evidence are still absent.
