...
export interface ApiProviderProbeState {
  "category"?: string
  "code"?: string
  "detail": string
  "latency_ms": number
...
export interface EntityCoverageMatrixState {
  ...
  "gap_count": number
  "industry": string
  "next_actions": Array<"sources" | "knowledge" | "research">
  "reviewed_evidence_total": number
}
